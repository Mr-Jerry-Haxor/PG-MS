...
urlpatterns = [
    ...
    path('whatsapp-cloud/', views.whatsapp_cloud_configs, name='sa_whatsapp_cloud_configs'),
    path('whatsapp-cloud/<int:pg_id>/', views.whatsapp_cloud_config_edit, name='sa_whatsapp_cloud_config_edit'),
